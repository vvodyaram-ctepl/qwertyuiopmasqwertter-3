...
@Component({
  selector: 'app-view-duplicate-pet',
  templateUrl: './view-duplicate-pet.component.html',
  styleUrls: ['./view-duplicate-pet.component.scss']
})
export class ViewDuplicatePetComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.params.subscribe(async params => {
      ...
      this.spinner.show();
      this.petParentService.getPetParentService(`/api/duplicatePets/getDuplicatePetConfigById/${params.id}`).subscribe(res => {
